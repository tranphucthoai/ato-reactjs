    ...
    return (
        <article className="post post--vertical post--vertical-reverse">
            <div className="post__meta inverse-text">
                <div className="post__readmore">
                    <Link to={`${match.url}:${data?.dataId}`}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="10.751"
                            ...
                            <path id="right-arrow"
                                ...
                                transform="translate(20 -4.674)"></path>
                        </svg>
                    </Link>
                </div>
            </div>
            ...
            <div className="post__text inverse-text ">
                <Link className="post__cat text-uppercase f-12" to={`${match.url}:${data?.dataId}`}>
                    {data?.categoryName}
                </Link>
