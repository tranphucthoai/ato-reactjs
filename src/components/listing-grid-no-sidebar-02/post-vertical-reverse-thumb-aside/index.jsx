                    ...
                    <div className="post__readmore">
                        <Link to={`${match.url}:${data?.dataId}`}>
                            <span className="post__readmore-text f-16 f-w-400 me-5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="46.426"
                                    height="46.427" viewBox="0 0 46.426 46.427">
                                    <g id="Group_19239" data-name="Group 19239"
                                        transform="translate(3193.173 -4335.393) rotate(45)">
                                        <line id="Line_425" data-name="Line 425" x1="20" y2="20"
                                            transform="translate(820.5 5313.5)" fill="none"
                                            stroke="#222222" strokeLinecap="round"
                                            strokeWidth="2"></line>
                                        <line id="Line_426" data-name="Line 426" x2="20" y2="20"
                                            transform="translate(840.5 5313.5)" fill="none"
                                            stroke="#222222" strokeLinecap="round"
                                            strokeWidth="2"></line>
                                        <line id="Line_427" data-name="Line 427" y2="40"
                                            transform="translate(840.5 5313.5)" fill="none"
                                            stroke="#222222" strokeLinecap="round"
                                            strokeWidth="2"></line>
                                    </g>
